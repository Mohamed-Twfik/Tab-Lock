...
const AddUrl = () => {
  ...
  return (
   ...
   >
    ...
    <button aria-label="add url" className="absolute text-2xl left-[76%] bottom-0 bg-green-400 p-[0.2rem] rounded text-white font-bold hover:bg-green-800 disabled:cursor-not-allowed disabled:bg-gray-500" disabled={addUrlMutation.isPending || addUrlMutation.isError}>
      {
